        ...
        <div class="card mb-2">
            ...
            <div class="card-body text-center">
                <ul class="list-inline d-flex flex-wrap justify-content-center mb-0">
                    <li><img src="{{ $rival->user_country ? asset('sppassport/flags/' . strtolower($rival->user_country) . '.svg') : '' }}" width="48" height="36" class="rounded shadow-sm mb-1">
                ...
                <ul class="list-inline d-flex flex-wrap justify-content-center gap-5 mb-0">
                    @foreach($rareCountries as $airport)
                        <li class="text-center">
                            ...
                            <a href="{{ route('passport.flights.country', ['country' => strtoupper($airport->country)]) }}">
                                @lang('sppassport::common.search')
                            </a>
                        </li>
                    @endforeach
