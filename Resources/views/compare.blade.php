...
@php
    function cmp_icon($diff) {
        if ($diff > 0) {
            return '<i class="bi bi-hand-thumbs-up-fill text-success float-end"></i>';
        } elseif ($diff < 0) {
            return '<i class="bi bi-hand-thumbs-down-fill text-danger float-end"></i>';
        }
        return '<i class="bi bi-circle-fill text-muted float-end"></i>';
    }
...
<div class="row">
    <div class="col-md-12">
        <div class="card mt-4">
            <div class="card-header bg-primary text-white">@lang('sppassport::common.advanced_comparisons')</div>
            <div class="card-body">
                <table class="table table-responsive align-middle">
                    <tbody>
                        <tr>
                        ...
                        <tr class="fw-bold text-center">
                            ...
                            <td>
                                @if($winner === 'Tie')
                                    <i class="bi bi-circle-fill text-primary"></i> @lang('sppassport::common.tie')
                                @elseif($winner === 'You')
